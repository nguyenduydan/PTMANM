...
{
    $birthDate = new DateTime($birthDate); // Chuyển đổi ngày sinh thành đối tượng DateTime
    $today = new DateTime(); // Lấy ngày hiện tại
    return $today->diff($birthDate)->y; // Tính toán tuổi
}
?>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= calculateAge($employee['ngaySinh']); ?></td>
